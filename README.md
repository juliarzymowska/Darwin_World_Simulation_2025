...
- **Animal behavior** (movement, reproduction, energy management)
- **Genotype operations** (mutation, inheritance)
- **Map mechanics** (placement, boundaries, collisions)
- **Pheromone system** (decay, detection, influence)
- **Utility classes** (vectors, directions, managers)
...
```bash
open project/build/reports/tests/test/index.html  # macOS
xdg-open project/build/reports/tests/test/index.html  # Linux
start project\build\reports\tests\test\index.html  # Windows
```
...
<!-- Placeholder for video/GIF demonstration -->

### Simulation in Action

*[Insert video or GIF here showing the simulation running with pheromone visualization]*

**Key Visual Elements:**
- 🟢 **Green animals** with orientation indicators
- 🌿 **Plants** distributed across the map
- 🔵 **Blue pheromone overlays** showing chemical trails
...
- Main simulation view with pheromones
- Statistics and tracking panels
...
- Project variant: **F - Zapachy i Feromony (Smells and Pheromones)**

### Team
- Implementation: Julia Rzymowska and team
- Year: 2025
- University: AGH University of Science and Technology

### Acknowledgments
- AGH Object-Oriented Programming course instructors
- Original project specification authors
...
This is a completed academic project. For educational purposes, feel free to:
- Fork the repository
...
For questions about this implementation, please refer to the original course materials or contact the project maintainers.
